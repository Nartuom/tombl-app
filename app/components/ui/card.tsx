...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex shrink bg-black/50 backdrop-blur-sm bg-gradient-to-b from-black/30 via-black/50 to-black/30 text-white border border-accent rounded-2xl shadow-lg py-4 px-4",
